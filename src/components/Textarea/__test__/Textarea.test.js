...
describe('<Textarea />', () => {
  ...
  it('value', () => {
    ...
    expect(ta1.instance().value).toEqual('John Snow');
    expect(ta2.instance().value).toEqual(10);
    expect(ta3.instance().value).toEqual('John Snow');
    expect(ta4.instance().value).toEqual('10');
  });
  ...
  it('placeholder, disabled, autoFucus', () => {
    ...
    expect(ta1.instance().props.placeholder).toEqual('placeholder');
    expect(ta2.instance().props.disabled).toEqual(true);
    expect(ta2.find('.is-disabled')).toHaveLength(1);
    expect(ta3.instance().props.autoFocus).toEqual(true);
  });
  ...
  it('label', () => {
    ...
    expect(ta1.instance().props.label).toEqual('label');
    expect(ta1.instance().props.labelPosition).toEqual('top');
    expect(ta2.instance().props.label).toEqual('label');
    expect(ta2.instance().props.labelPosition).toEqual('left');
    expect(ta3.instance().props.label).toEqual('label');
    expect(ta3.instance().props.labelPosition).toEqual('right');
    expect(ta4.instance().props.label).toEqual('label');
    expect(ta4.instance().props.required).toEqual(true);
  });
  ...
  it('error', () => {
    ...
    expect(ta1.instance().props.errors).toHaveLength(3);
  });
