...
describe('<Select />', () => {
  ...
  it('dataSource, autoFetch, mapValue, customItemTpl', () => {
    ...
    expect(typeof (sel1.instance() as any).props.dataSource).toEqual('function');
    expect((sel2.instance() as any).props.autoFetch).toEqual(true);
    expect((sel3.instance() as any).props.mapValue).toEqual('name');
    expect(typeof (sel4.instance() as any).props.customItemTpl).toEqual('function');
  });
  ...
  it('value', () => {
    ...
    expect((sel1.instance() as any).value).toEqual('John Snow');
    expect((sel2.instance() as any).value).toEqual(value);
  });
  ...
  it('placeholder, disabled, autoFucus', () => {
    ...
    expect((sel2.instance() as any).props.disabled).toEqual(true);
  ...
  it('label', () => {
    ...
    expect((sel1.instance() as any).props.label).toEqual('label');
    expect((sel1.instance() as any).props.labelPosition).toEqual('top');
    expect((sel2.instance() as any).props.label).toEqual('label');
    expect((sel2.instance() as any).props.labelPosition).toEqual('left');
    expect((sel3.instance() as any).props.label).toEqual('label');
    expect((sel3.instance() as any).props.labelPosition).toEqual('right');
    expect((sel4.instance() as any).props.label).toEqual('label');
    expect((sel4.instance() as any).props.required).toEqual(true);
  });
  ...
  it('error', () => {
    ...
    expect((sel1.instance() as any).props.errors).toHaveLength(3);
  });
