...
describe('<Input />', () => {
  ...
  it('value', () => {
    ...
    const inst1: any = inp1.instance();
    const inst2: any = inp2.instance();

    expect(inst1.value).toEqual('John Snow');
    expect(inst2.value).toEqual(10);
  });
  ...
  it('label', () => {
    ...
    expect((inp1.instance() as any).props.label).toEqual('label');
    expect((inp1.instance() as any).props.labelPosition).toEqual('top');
    expect((inp2.instance() as any).props.label).toEqual('label');
    expect((inp2.instance() as any).props.labelPosition).toEqual('left');
    expect((inp3.instance() as any).props.label).toEqual('label');
    expect((inp3.instance() as any).props.labelPosition).toEqual('right');
    expect((inp4.instance() as any).props.label).toEqual('label');
    expect((inp4.instance() as any).props.required).toEqual(true);
  });
  ...
  it('icon', () => {
    ...
    expect((inp1.instance() as any).props.leftIcon).toEqual('user');
    expect((inp2.instance() as any).props.rightIcon).toEqual('at');
    expect((inp3.instance() as any).props.leftIcon).toEqual('user');
    expect((inp3.instance() as any).props.rightIcon).toEqual('at');
  });
  ...
  it('error', () => {
    ...
    expect((inp1.instance() as any).props.errors).toHaveLength(3);
  });
